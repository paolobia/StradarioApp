...
- **Data/ora opzionali su POI e percorsi**: campo Da/A facoltativo su ogni POI e su ogni percorso — quando presente, l'albero di navigazione si riordina cronologicamente in automatico e il PDF genera una pagina "Piano di viaggio" dedicata (non datati in coda) subito dopo la copertina; senza alcuna data impostata il PDF resta identico a prima (nessuna pagina in più)
